...
<head>
    <meta charset="UTF-8">
    <title>Sandile's to CI News</title>
    ...
    <link rel="stylesheet" href="<?php echo base_url('styles/home_style.css'); ?>">
</head>
<body>
...
<header>
    ...
    <div class="menu">
        <ul>
            ...
            <li class="menu-item hidden"><a href="<?= site_url('auth/news') ?>">News</a></li>
            <li class="menu-item hidden"><a href="<?= site_url('auth/forgot_password') ?>" target="_blank">Segment</a>
            </li>
    ...
    <div class="heroe">
        ...
        <h1>Welcome to CI-News</h1>

        <h2>My Attempt at Learning CodeIgniter and CodeIgniter Auth</h2>
